...
export const MainNavItem = motion.custom(styled(Link)`
  ${tw`relative text-gray-100 border-b border-transparent hover:text-gray-100 ml-0 sm:ml-8 mt-3 sm:mt-0`};
  width: max-content;
...
export const ToogleMainNav = styled.button`
  ...
  span {
    ${tw`bg-gray-100 inline-block w-6 h-px`};
    transition: 0.2s;
    ...
    &:nth-child(2) {
      ${tw`bg-gray-500 inline-block w-8 h-px`};
